        ...
        {loading ? <Loading /> : <div className="container">
          <div className="topheadertitle flex flex-sb">
            <div>
              ...
              <p className="mb-2 w-66">Discover movies from every genre, whether it’s action, drama, horror, or comedy. From timeless classics to trending blockbusters, there’s something for every mood. Start your journey and find your next favorite movie today!</p>
              <Link href="https://www.moviexyz.com/"><button>Exclusive On <span>MovieXYZ</span></button></Link>
            </div>
