...
export default function Header() {
    ...
    // function for when click outside of the search bar will be close
    ...
    useEffect(() => {
        // update active link state when the page is reloded
    ...
    return <>
        <nav className="header">
            <h1 className="logo" data-text="&nbsp;MovieXYZ&nbsp;">
                <a href="/">&nbsp;MovieXYZ&nbsp;</a>
            </h1>
                    ...
                    <div className="search_results">
                        ...
                        <ul>
                            {searchResult.length > 0 ? (
                                // showing 20 search result by matching words
                ...
                <ul className={clicked ? "navbar active" : "navbar"} onClick={handleNabarClose}>
                    ...
                    <li>
                        <Link href='/bollywood'
                            ...
                            onClick={() => handleLinkClick('/bollywoood')}
                        >Bollywood</Link>
                    </li>
                    <li>
                        <Link href='/hollywood'
